...
const DashboardPage = () => {
  ...
  return (
    <Layout>
      {/* HEADER */}
      <div className="flex justify-between items-start mb-[2rem] p-[1.5rem] rounded-[1rem] text-white shadow-[0_8px_32px_rgba(102,126,234,0.3)] bg-gradient-to-br from-[#667eea] to-[#764ba2] max-md:flex-col max-md:gap-[1rem] max-md:text-center">
        <div>
          ...
          <p className="mt-[0.5rem] text-[1rem] opacity-90">
            ...
            <span
              className={`inline-flex items-center px-[0.75rem] py-[0.25rem] rounded-full text-[0.8rem] font-semibold uppercase tracking-[0.05em] backdrop-blur border
                ${
        ...
        {/* QUICK STATS */}
        <div className="flex flex-col items-end gap-[0.5rem] max-md:items-center max-md:flex-row max-md:flex-wrap max-md:justify-center">
